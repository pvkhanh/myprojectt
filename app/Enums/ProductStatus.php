...
//     }
//     /**
//      * Trạng thái hiển thị ở Listing
//      */
//     public function visibleOnListing(): bool
//     {
//         return in_array($this, [self::Active, self::OutOfStock]);
//     }

//     /**
//      * Trạng thái hiển thị ở trang Chi tiết
//      */
//     public function visibleOnDetail(): bool
//     {
//         return in_array($this, [self::Active, self::OutOfStock, self::Discontinued]);
//     }
...
enum ProductStatus: string
{
    ...
    /**
     * Lấy danh sách giá trị (string) dùng cho whereIn listing
     */
    public static function visibleOnListingValues(): array
    {
        return array_map(fn(self $s) => $s->value, array_filter(self::cases(), fn(self $c) => $c->visibleOnListing()));
    }

    /**
     * Lấy danh sách giá trị (string) dùng cho whereIn detail (nếu cần)
     */
    public static function visibleOnDetailValues(): array
    {
        return array_map(fn(self $s) => $s->value, array_filter(self::cases(), fn(self $c) => $c->visibleOnDetail()));
    }
