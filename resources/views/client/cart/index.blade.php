                    ...
                    @foreach ($cartItems as $item)
                        <div class="cart-item" data-item-id="{{ $item->id }}">
                            <div class="item-image">
                                <img src="{{ $item->product->image ?? 'https://via.placeholder.com/140' }}"
                                    alt="{{ $item->product->name }}">
                                @if ($item->product->discount_percent > 0)
                                    <span class="item-badge">-{{ $item->product->discount_percent }}%</span>
                                @endif
                            </div>
                            ...
                            <div class="item-details">
                                ...
                                <div class="item-price-section">
                                    ...
                                    @if ($item->original_price > $item->price)
                                        <span class="item-price-old">{{ number_format($item->original_price) }}đ</span>
                                        <span class="item-discount-badge">
                                            Tiết kiệm {{ number_format($item->original_price - $item->price) }}đ
                                        </span>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="item-actions">
                                ...
                                <div class="quantity-control">
                                    ...
                                    <input type="number" class="qty-input" value="{{ $item->quantity }}" min="1"
                                        max="{{ $item->product->stock }}" data-item-id="{{ $item->id }}" readonly>
                ...
                <div class="cart-summary">
                    ...
                    <div class="coupon-section">
                        ...
                        <div class="coupon-input">
                            <input type="text" placeholder="Nhập mã giảm giá" id="couponCode" maxlength="20">
                    ...
                    <div class="summary-row">
                        ...
                        <span class="value text-success">-{{ number_format($discount ?? 0) }}đ</span>
                    </div>
                    ...
                    <div class="trust-badges">
                        ...
                        <div class="trust-badge-item">
                            ...
                            <small class="text-muted">Miễn phí vận chuyển từ 500K</small>
                        </div>
                        <div class="trust-badge-item">
        ...
        $(document).ready(function() {
            ...
            $('#applyCoupon').click(function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        showToast(response.message || 'Áp dụng mã giảm giá thành công!',
                            'success');
                        setTimeout(() => location.reload(), 1000);
                    },
                    error: function(xhr) {
                        showToast(xhr.responseJSON?.message || 'Mã giảm giá không hợp lệ',
                            'danger');
                    },
                    complete: function() {
                        $('#applyCoupon').prop('disabled', false).html(
                            '<i class="fas fa-check me-1"></i>Áp dụng');
                    }
                });
            });
