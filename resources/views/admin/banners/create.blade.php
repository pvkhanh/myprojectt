                ...
                <form action="{{ route('admin.banners.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="title"
                                    ...
                                    value="{{ old('title') }}" placeholder="Nhập tiêu đề banner..." required>
                                @error('title')
                            ...
                            {{-- Image Upload --}}
                            <div class="mb-4">
                                <label class="form-label fw-semibold required">Ảnh banner</label>
                                <div class="border-dashed border-2 rounded p-4 text-center bg-light" id="dropZone">
                                    <input type="file" name="image_file" class="d-none @error('image') is-invalid @enderror"
                                        accept="image/*" id="imageInput" required>
                                    <div id="dropZoneContent">
                                        <i class="fas fa-cloud-upload-alt fa-3x text-primary mb-3"></i>
                                        <p class="mb-2 fw-semibold">Kéo thả ảnh vào đây hoặc <a href="#"
                                                id="browseBtn" class="text-primary">chọn file</a></p>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="type" class="form-select">
                                        ...
                                        <option value="sidebar" {{ old('type') == 'sidebar' ? 'selected' : '' }}>Sidebar
                                        </option>
                                        <option value="popup" {{ old('type') == 'popup' ? 'selected' : '' }}>Popup</option>
                                        <option value="footer" {{ old('type') == 'footer' ? 'selected' : '' }}>Footer
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="border-top mt-4 pt-4">
                                <h6 class="fw-bold mb-3"><i class="fas fa-calendar-alt me-2 text-primary"></i>Lên lịch hiển
                                    thị (Tùy chọn)</h6>
                                <div class="row g-3">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="datetime-local" name="end_at" class="form-control"
                                            value="{{ old('end_at') }}">
                                        <small class="text-muted">Để trống = hiển thị vô thời hạn</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="d-flex gap-2 justify-content-between mb-4">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <button type="submit" name="action" value="save_continue" class="btn btn-success btn-lg">
