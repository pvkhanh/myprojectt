        ...
        <div class="card border-0 shadow-sm">
                    ...
                    @forelse($banners as $banner)
                        <div class="col-md-6 col-lg-4 banner-item" data-id="{{ $banner->id }}">
                            <div class="card h-100 shadow-sm border-0 position-relative banner-card">
                                ...
                                {{-- Drag Handle --}}
                                <div class="position-absolute top-0 end-0 p-3 drag-handle"
                                    style="cursor: move; display: none; z-index: 10;">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex gap-2 mt-3">
                                        <button
                                            class="btn btn-sm btn-outline-{{ $banner->is_active ? 'warning' : 'success' }} flex-fill toggle-status"
                                            data-id="{{ $banner->id }}">
                            ...
                            <form action="{{ route('admin.banners.destroy', $banner) }}" method="POST" class="d-none"
            ...
            <div class="card-footer d-flex justify-content-between align-items-center">
                <div class="text-muted small">
                    Hiển thị {{ $banners->firstItem() ?? 0 }} - {{ $banners->lastItem() ?? 0 }} trong tổng số
