                ...
                <div class="card border-0 shadow-lg mb-4">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <select name="type" class="form-select">
                                    ...
                                    <option value="sidebar" {{ old('type', $banner->type) == 'sidebar' ? 'selected' : '' }}>Sidebar</option>
                                    <option value="popup" {{ old('type', $banner->type) == 'popup' ? 'selected' : '' }}>Popup</option>
                                    <option value="footer" {{ old('type', $banner->type) == 'footer' ? 'selected' : '' }}>Footer</option>
                                </select>
                            </div>
                        ...
                        <div class="border-top mt-4 pt-4">
                            <h6 class="fw-bold mb-3"><i class="fas fa-calendar-alt me-2 text-warning"></i>Lên lịch hiển thị</h6>
                            <div class="row g-3">
                                <div class="col-md-6">
