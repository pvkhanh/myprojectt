...
<div class="container-fluid px-4">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('admin.user-addresses.show', $address->id) }}" class="btn btn-outline-secondary">
    ...
    <form action="{{ route('admin.user-addresses.update', $address->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4">
                ...
                <div class="d-grid gap-2 mt-4">
                    ...
                    <a href="{{ route('admin.user-addresses.show', $address->id) }}" class="btn btn-outline-secondary btn-lg">
