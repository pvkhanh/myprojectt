                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <span class="fw-semibold">{{ $user->birthday ? $user->birthday->format('d/m/Y') : '—' }}</span>
                            </div>
                        </div>
                        @if($user->bio)
                            <div class="col-12">
            ...
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body">
                    @forelse($user->addresses as $address)
                        <div class="border rounded p-3 mb-3 {{ $address->is_default ? 'border-primary bg-light' : '' }}">
