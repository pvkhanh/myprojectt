                ...
                <div class="card-body">
                    <div class="d-grid gap-3">
                        @if ($actions['canConfirmPayment'])
                            <button type="button" class="btn action-btn btn-confirm-order" data-bs-toggle="modal" data-bs-target="#confirmPaymentModal">
                        ...
                        @if ($actions['canRejectPayment'])
                            <button type="button" class="btn action-btn btn-cancel-order" data-bs-toggle="modal" data-bs-target="#rejectPaymentModal">
                        ...
                        @if ($actions['canMarkAsShipped'])
                            <button type="button" class="btn action-btn btn-ship" data-bs-toggle="modal" data-bs-target="#shipModal">
                        ...
                        @if ($actions['canCancel'])
                            <button type="button" class="btn action-btn btn-cancel-order" data-bs-toggle="modal" data-bs-target="#cancelModal">
                ...
                <div class="card-body">
                    @if ($order->user)
                        <div class="text-center mb-3">
                            ...
                            <h6 class="fw-bold mb-1">{{ $order->user->first_name }} {{ $order->user->last_name }}</h6>
                        ...
                        <div class="d-grid gap-2">
                            ...
                            @if ($order->shippingAddress)
                            <a href="tel:{{ $order->shippingAddress->phone }}" class="btn btn-outline-success btn-sm">
            ...
            <form action="{{ route('admin.orders.confirm-payment', $order->id) }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="transaction_id" class="form-control" placeholder="VD: TXN123456">
                    </div>
                    <div class="mb-3">
            ...
            <form action="{{ route('admin.orders.reject-payment', $order->id) }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <textarea name="reason" class="form-control" rows="4" required placeholder="VD: Thông tin chuyển khoản không chính xác..."></textarea>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Hủy</button>
            ...
            <form action="{{ route('admin.orders.update-status', $order->id) }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="tracking_code" class="form-control" placeholder="VD: SPX123456">
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Hủy</button>
            ...
            <form action="{{ route('admin.orders.cancel', $order->id) }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="reason" class="form-control" rows="4" required placeholder="VD: Khách hàng yêu cầu hủy đơn..."></textarea>
                    </div>
                </div>
                <div class="modal-footer">
